...
public class MainActivity extends AppCompatActivity implements BiometricCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new BiometricManager.BiometricBuilder(MainActivity.this)
                .setTitle("Es necesario autenticarse")
                .setSubtitle("Por privacidad a nuestros datos, es necesario que accedas con este paso")
                .setDescription("Gracias!")
    ...
    public void onAuthenticationCancelled() {
        Toast.makeText(this, "Autenticacion cancelada", Toast.LENGTH_LONG).show();
    ...
    public void onAuthenticationSuccessful() {
        ...
        Toast.makeText(this, "Autenticacion correcta, difrute de las playlist", Toast.LENGTH_LONG).show();
        Toast.makeText(this, "Gracias por usar nuestra app!", Toast.LENGTH_LONG).show();
        Toast.makeText(this, "Integrantes del equipo", Toast.LENGTH_LONG).show();
        Toast.makeText(this, "Brandon Ramiro Hernandez Mendez", Toast.LENGTH_LONG).show();
        Toast.makeText(this, "Jesus Roberto Rosales Covarrubias", Toast.LENGTH_LONG).show();
        Toast.makeText(this, "Luis Angel Martinez Ramirez", Toast.LENGTH_LONG).show();
